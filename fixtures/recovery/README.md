...
outside the headless language core, and the product Runtime test proves that a
synthesis failure keeps accessible narration and lesson playback independent.
